...
프로필을 JSON 문자열 한 개로 저장하면 한 번에 읽기 쉽지만 필드 하나를 바꿀 때 전체 문서를 읽고 직렬화해 다시 써야 할 수 있습니다. 동시 갱신이면 다른 필드의 변경도 덮을 수 있습니다. hash의 필드 갱신·set의 존재 검사·sorted set의 순서 조회처럼 필요한 연산에서 자료형을 고릅니다.
