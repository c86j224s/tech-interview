...
## 볼륨이 다시 붙어도 데이터가 최신이라는 증거는 아닙니다
...
## WaitForFirstConsumer는 배치와 볼륨 위치를 맞춥니다
...
## RPO·RTO는 새 Pod Ready보다 넓게 측정합니다
