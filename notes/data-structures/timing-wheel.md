...
같은 버킷을 순회하는 동안 콜백이 새 타이머를 추가하지 않도록 실제 콜백 실행은 별도 ready 큐에서 합니다. 지나간 기한을 등록하면 다음 처리 기회로 보낸다는 정책이며 즉시 실행 계약이 아닙니다. 반올림·정수 범위·기준 시각 재설정도 검사해야 합니다.

## 계층형 휠은 먼 미래를 거칠게 보관합니다
