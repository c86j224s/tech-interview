...
한 term에서 한 후보에게만 투표하도록 currentTerm·votedFor를 내구 상태로 유지합니다. vote 응답 후 저장 전에 죽으면 재시작 뒤 다른 후보에게 같은 term의 표를 줄 수 있습니다. 저장을 먼저 하는 순서가 crash/recovery 모델의 안전성에 필요합니다. log 수락 응답도 필요한 내구 기록과 연결해야 합니다.
