...
## Vector가 복사를 고르는 이유는 실패 뒤 상태입니다
...
복사가 불가능하고 이동이 던질 수 있는 타입은 해당 vector 연산의 강한 예외 보장이 제한될 수 있습니다. 타입·연산별 표준 계약을 확인합니다. 실제로 예외가 나올 수 있는데 성능 때문에 noexcept만 붙이면 예외 발생 시 terminate로 이어집니다. 선언은 최적화 힌트가 아니라 지켜야 할 계약입니다.

## Allocator가 다르면 버퍼를 넘길 수 없을 수 있습니다
